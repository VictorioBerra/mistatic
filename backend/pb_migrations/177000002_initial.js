  ...
  const snapshot = [
    ...
    },
    {
      ...
      "fields": [
        ...
        {
          "cascadeDelete": false,
          "collectionId": "pbc_3352125601",
          "help": "",
          "hidden": false,
          "id": "relation3400546120",
          "maxSelect": 1,
          "minSelect": 0,
    ...
    {
      "createRule": "@request.auth.id = site.user.id",
      "deleteRule": "@request.auth.id = site.user.id",
      "fields": [
        {
          "autogeneratePattern": "[a-z0-9]{15}",
          "help": "",
      ...
      "id": "pbc_3352125601",
      "indexes": [],
      "listRule": "@request.auth.id = site.user.id",
      "name": "deployments",
      "system": false,
      "type": "base",
      "updateRule": "@request.auth.id = site.user.id",
      "viewRule": "@request.auth.id = site.user.id"
    },
    {
      "createRule": "@request.auth.id = site.user.id",
      "deleteRule": "@request.auth.id = site.user.id",
